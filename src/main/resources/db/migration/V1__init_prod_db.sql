-- NOTE: This is a PostgreSQL migration file.
-- Codacy SQL warnings about missing SQL Server settings can be ignored.
-- These warnings are false positives as their SQL Server specific.
